...
public class LauncherActivity extends BaseActivity {
    ...
    protected void onResume() {
        ...
        net.kdt.pojavlaunch.pengu.PenguGuncelleme.kontrolEt(this);
    }
    ...
    public void onBackPressed() {
        ...
        Fragment kok = getVisibleFragment("ROOT");
        if(kok != null){
            // Pengu: ana ekran web arayuzu; once icindeki acik pencereyi kapatmayi dene
            if (kok instanceof MainMenuFragment) {
                ((MainMenuFragment) kok).geriBas(this::finish);
                return;
            }
            finish();
        }
    ...
    /** Pengu: web arayuzu hesaplari bu gizli secici uzerinden yonetiyor */
    public mcAccountSpinner getHesapSecici() {
